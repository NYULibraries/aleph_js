function bs_process_booking() {
    ...
    jQuery.validator.addMethod("closed", function(value, element) {
        return jQuery(element).data("hours")[jQuery(element).datepicker("getDate").getDay()] != "Closed"
    }, "The library is closed on the day selected.");
